...
public final class StringUtil {
	...
	private final static String LOCAL_TEN_K_DIR="C:\\SEC\\10-K";

	public static String getLocal10KFileName(String ticker, int index) {
		String directoryName = LOCAL_TEN_K_DIR+"\\" + ticker;
		...
		return directoryName + "\\" + ticker +"_" +  index +".htm";

	}

	public static String getLocalRiskFactorFileName(String ticker, int index) {
		String directoryName = LOCAL_TEN_K_DIR+"\\" + ticker;
		File directory = new File(String.valueOf(directoryName));
		...
		return directoryName + "\\" + ticker + "_RiskFactors_" +  index +".htm";
